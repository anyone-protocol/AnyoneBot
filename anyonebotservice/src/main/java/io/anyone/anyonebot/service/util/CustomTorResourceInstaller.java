...
public class CustomTorResourceInstaller {
    ...
    public void installGeoIP() throws IOException {
        ...
        assetToFile(AnyoneBotConstants.GEOIP_ASSET_KEY, AnyoneBotConstants.GEOIP_ASSET_KEY, false, false);
        assetToFile(AnyoneBotConstants.GEOIP6_ASSET_KEY, AnyoneBotConstants.GEOIP6_ASSET_KEY, false, false);
    }
