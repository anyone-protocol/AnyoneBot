...
public class AnyoneBotVpnManager implements Handler.Callback, AnyoneBotConstants {
    ...
    private final static String mSessionName = "AnyoneBotVPN";
    ...
    public AnyoneBotVpnManager(AnyoneBotService service) {
        mService = service;
...
//                    int torHttp = intent.getIntExtra(OrbotService.EXTRA_HTTP_PROXY_PORT,-1);
    ...
    private void doAppBasedRouting(VpnService.Builder builder) throws NameNotFoundException {
        ...
        if (!individualAppsWereSelected && !isLockdownMode) {
            ...
            for (String packageName : AnyoneBotConstants.BYPASS_VPN_PACKAGES)
